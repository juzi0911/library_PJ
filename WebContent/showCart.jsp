	...
	<c:if test="${empty sessionScope.cart.itmes}">
		<div style="margin-left: 600px; margin-top: 100px">
			...
			<h4 style="margin-left: 170px">
				<strong>空空如也！快去把喜欢的宝贝添加进这里吧！！！</strong> <a href="/client/ClientServlet?op=category">返回主页</a>
			</h4>
		</div>
	</c:if>
	<c:if test="${!empty sessionScope.cart.itmes}">
		<table class="table table-bordered table-hover"
			...
			<tr>
				...
				<%--<th style="width: 100px">选课图片</th>--%>
				<th style="width: 200px">书籍名称</th>
				<th style="width: 200px">书籍类型</th>
				<th style="width: 200px">书籍作者</th>
				<th style="width: 300px">出版社</th>
				<th style="width: 200px">购买单价</th>
				<%--<th style="width: 200px">选课数量</th>--%>
				<%--<th style="width: 200px">退课价格</th>--%>
			...
			<c:forEach items="${sessionScope.cart.itmes}" var="c" varStatus="vs">
				<tr class="active">
					...
					<td><a href="javascript:delOneItem('${c.value.book.book_id}')">购买</a></td>    <%--<a href="javascript:delOneItem('${c.value.book.book_id}')">--%>
				</tr>
			</c:forEach>
			<tr>
				<td colspan="10" style="padding-left: 1450px"><strong>总数量：<span
					...
					<button type="button" class="btn btn-danger"
						...
						<span style="font-size: 16px">全部购买</span>
					</button></td>
