...
">
	...
	<table class="table table-bordered table-hover"
		...
		<tr>
			...
			<th style="width: 100px">书籍情况</th>
			<th style="width: 200px">书籍名称</th>
			<th style="width: 200px">书籍类型</th>
			<th style="width: 200px">书籍作者</th>
			<th style="width: 300px">出版社</th>
			<th style="width: 200px">购买价格</th>
			<th style="width: 200px">购买人数</th>
			<th style="width: 200px">书籍库存</th>
		...
		<c:forEach items="${books}" var="s" varStatus="vs">
			<tr class="active">
				...
				<td><img style="width: 80px; height: 60px"
					src="${pageContext.request.contextPath}/img/${s.path}/${s.book_xiaonumber}/1.jpg"/><%--s.filename--%>
				</td>
				<td>${s.book_name}</td>
				...
				<td>${s.book_maxium}</td>
				<td><a
					href="<%=basePath%>/client/ClientServlet?op=particulars&book_id=${s.book_id}">详情</a><br>
				    <a
					href="<%=basePath%>/client/ClientServlet?op=video&book_id=${s.book_id}">视频介绍</a></td>
			</tr>
		</c:forEach>
	</table>
