...
<head>
    ...
    <title>复日网上书城系统-日复日兮，日月光华</title> <%--目前不清楚它显示在了哪里--%>
        ...
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <c:if test="${!empty user}">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span
                    style="color: red; font-weight: bold">${sessionScope.user.name}</span>&nbsp;&nbsp;&nbsp;&nbsp;，复日网上书城系统欢迎您。<%--这里已经跳转到普通用户登录后的主页了--%>
                ...
                <c:if test="${empty user}">
                    <div style="float: right; margin-right: 7px; margin-top: 10px">
                        <button type="button" class="btn btn-default btn-sm"
                                onclick="window.location='/ex4-17-login.jsp'">
                            <span>树洞</span>
                        </button>
                        <!-- 登录 -->
                        <button type="button" class="btn btn-default btn-sm"
...
<!-- 轮播图 -->
<div>
    <div style="width:1000px;height:300px" class="container-fluid">
        <div id="carousel-example-generic" class="carousel slide"
            ...
            <div class="carousel-inner" role="listbox">
                ...
                <div class="item">
                    <img src="<%=basePath%>/img/l3.jpg">
                    <div class="carousel-caption">
                        <!-- 轮播图上的文字 -->
                    </div>
                </div>
                <div class="item">
                    <img src="<%=basePath%>/img/l4.jpg">
                    <div class="carousel-caption">
                        <!-- 轮播图上的文字 -->
                    </div>
                </div>
                <div class="item">
                    <img src="<%=basePath%>/img/l5.jpg">
                    <div class="carousel-caption">
                        <!-- 轮播图上的文字 -->
                    </div>
                </div>
