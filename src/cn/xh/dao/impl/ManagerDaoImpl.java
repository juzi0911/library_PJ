...
public class ManagerDaoImpl implements ManagerDao {
	...
	public void addBook(Book book) {
		try {
			...
			prepareStatement.setInt(10, book.getBook_maxium());
	...
	public Book findBookById(String book_id) {
		...
		try {
			...
			if (rs.next()) {
				...
				book.setBook_kunumber(rs.getInt("book_maxium"));
				book.setBook_xiaonumber(rs.getInt("book_xiaonumber"));
				book.setBook_maxium(rs.getInt("book_maxium"));
			}
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public void editBook(String book_id, String book_name, String book_author, String book_press, String book_desc,
			double book_price, String book_maxium) {
		try {
			Connection connection = JDBCUtil.getConnection();
			PreparedStatement prepareStatement = connection.prepareStatement(
					"update bookdb set book_name=?,book_author=?,book_press=?,book_desc=?,book_price=?,book_maxium=? where book_id=?");
			...
			prepareStatement.setString(6, book_maxium);
