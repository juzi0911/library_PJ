...
public class OrderDaoImpl implements OrdetrDao {
		...
		try {
			...
			for (Orderitem item : items) {
				...
				PreparedStatement preparedStatement3 = connection.prepareStatement(
						"update bookdb set book_xiaonumber = book_xiaonumber+1 where book_id = ?");
				preparedStatement2.setString(1, item.getId());
				preparedStatement2.executeUpdate();
				preparedStatement3.setString(1, item.getBook().getBook_id());
	...
	public void tempDel(Order o) {
		try {
			...
			for (Orderitem item : items) {
				PreparedStatement preparedStatement3 = connection.prepareStatement(
						"update bookdb set book_xiaonumber = book_xiaonumber where book_id = ?");
				preparedStatement3.setString(1, item.getBook().getBook_id());
				preparedStatement3.executeUpdate();
			}}
		} catch (Exception e) {
