...
<body>
	...
	<div>
		<p style="font-size: 30px; margin-top: 20px; margin-left: 30px">书籍情况管理</p>
	</div>
	<hr
	...
	<table class="table table-bordered table-hover"
		...
		<tr>
			...
			<th style="width: 250px">账号</th>
			<th style="width: 200px">书籍数量</th>
			<th style="width: 200px">支付金额</th>
			<th style="width: 200px">书籍状态</th>
		...
		<c:forEach items="${orders}" var="os" varStatus="vs">
			<tr class="active">
				...
				<c:if test="${os.status==0}">
					<td>未发货</td>
					<td><a href="javascript:fahuo('${os.ordernum}')">打包发货</a></td>
				</c:if>
